...
# JHEP Writer Offline Resources Status

- Generated at: 2026-02-09T07:28:18Z
- User-Agent: `CodexCLI-JhepWriter/1.0 (+https://jhep.sissa.it)`

## Results
- [failed] `jhep_texclass.html` <- https://jhep.sissa.it/jhep/help/JHEP_TeXclass.jsp
- [failed] `jhep_author_manual.pdf` <- https://jhep.sissa.it/jhep/help/JHEP/TeXclass/DOCS/JHEP-author-manual.pdf
