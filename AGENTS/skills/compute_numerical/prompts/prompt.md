...
Use the structured JSON block in request.md. Generate clear Python code with comments, run it, capture stdout/stderr, and write a complete report under work/report.md.
