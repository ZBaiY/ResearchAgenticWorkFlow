...
Use the structured JSON block in request.md. Generate clear Wolfram Language code with comments, run it in batch mode, capture stdout/stderr, and write a complete report under work/report.md.
