...
- Export-on-consent is implemented for code-producing skills:
  - `AGENTS/skills/compute_numerical/scripts/run.sh`
  - `AGENTS/skills/compute_algebraic/scripts/run.sh`
...
3. Keep compute routing explicit via `compute_numerical` and `compute_algebraic`.
